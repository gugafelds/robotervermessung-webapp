...
export const TCPAccelPlot: React.FC<TCPAccelerationPlotProps> = React.memo(
  ({ currentTrajAccelAct, currentTrajAccelCmd }) => {
    const { plotData: tcpAccelPlotData, maxTimeAccel } = useMemo(() => {
      ...
      const computedMaxTimeAccel = getMaxTimeAccel();
      ...
      return {
        plotData,
        maxTimeAccel: computedMaxTimeAccel,
      };
    }, [currentTrajAccelAct, currentTrajAccelCmd]);
